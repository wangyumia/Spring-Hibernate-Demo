...
function MagicZoom(smallImageContId, smallImageId, bigImageContId, bigImageId, settings) {
	...
	if (this.settings["loadingImg"] != '') {
		...
		this.loadingCont.innerjsp = this.settings["loadingText"] + '<br/><img border="0" alt="' + this.settings["loadingText"] + '" src="' + this.settings["loadingImg"] + '"/>';
...
MagicZoom.prototype.checkcoords = function(e) {
	...
	while (tag && tag.tagName != "BODY" && tag.tagName != "jsp") {
...
MagicZoom.prototype.mousemove = function(e) {
	MagicZoom_stopEventPropagation(e);
	if (this.bigImageSizeX <= 300) return false;
	...
	if (MagicZoom_ua == 'gecko' || MagicZoom_ua == 'opera' || MagicZoom_ua == 'safari') {
		var tag = smallImg;
		while (tag.tagName != "BODY" && tag.tagName != "jsp") {
			smallY += tag.offsetTop;
			smallX += tag.offsetLeft;
			tag = tag.offsetParent
		}
...
MagicZoom.prototype.initPopup = function() {
	...
	this.pup.style["-jsp-opacity"] = parseFloat(this.settings['opacity'] / 100.0);
...
MagicZoom.prototype.initBigContainer = function() {
	...
	if (this.settings && this.settings["header"] != "") {
		...
		f.style.top = '0px';
		f.style.padding = '3px';
		f.innerjsp = this.settings["header"];
		this.bigImageCont.appendChild(f)
	}
...
MagicZoom.prototype.replaceZoom = function(e, ael) {
	...
	if (ael.title != '') {
		_el('MagicZoomHeader' + this.bigImageCont.id).innerjsp = ael.title
	}
	this.safariOnLoadStarted = false;
	this.initZoom()
};
