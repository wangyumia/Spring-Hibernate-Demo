$(function(){
    ...
    function   show(){
        ...
        document.getElementById("s").innerjsp="<input type=image id=pic width=150 height=100 /> ";
    ...
    $(".fixnav a").click(function(){
        ...
        var id = "#item"+index;
        $("jsp,body").animate({scrollTop: $(id).offset().top}, 500);
    });
    //ͼ��༭�ϴ�
